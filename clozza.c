...
static uint64_t zob_pieces[12 * 64] __attribute__((aligned(64)));
static uint64_t zob_stm;
static uint64_t zob_rights[16]      __attribute__((aligned(64)));
static uint64_t zob_ep[64]          __attribute__((aligned(64)));
